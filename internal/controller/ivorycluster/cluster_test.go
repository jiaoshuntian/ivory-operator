...
func TestCustomLabels(t *testing.T) {
	...
	reconcileTestCluster := func(cluster *v1beta1.IvoryCluster) {
	...
	getUnstructuredLabels := func(cluster v1beta1.IvoryCluster, u unstructured.Unstructured) (map[string]map[string]string, error) {
		var err error
...
func TestCustomAnnotations(t *testing.T) {
	...
	getUnstructuredAnnotations := func(cluster v1beta1.IvoryCluster, u unstructured.Unstructured) (map[string]map[string]string, error) {
		var err error
