...
var _ = Describe("IvoryCluster Reconciler", func() {
	var test struct {
	...
	BeforeEach(func() {
		...
		test.Namespace.Name = "ivory-operator-test-" + rand.String(6)
	...
	create := func(clusterYAML string) *v1beta1.IvoryCluster {
		ctx := context.Background()
	...
	reconcile := func(cluster *v1beta1.IvoryCluster) reconcile.Result {
		ctx := context.Background()
