...
func (r *Reconciler) reconcilePGBouncer(
	...
	if err == nil {
		err = r.reconcilePGBouncerInIvorySQL(ctx, cluster, instances, secret)
	}
	return err
}
...
// reconcilePGBouncerInIvorySQL writes the user and other objects needed by
// PgBouncer inside of IvorySQL.
func (r *Reconciler) reconcilePGBouncerInIvorySQL(
	ctx context.Context, cluster *v1beta1.IvoryCluster, instances *observedInstances,
	...
	action := func(ctx context.Context, exec ivory.Executor) error {
		return errors.WithStack(pgbouncer.EnableInIvorySQL(ctx, exec, clusterSecret))
	}
	if cluster.Spec.Proxy == nil || cluster.Spec.Proxy.PGBouncer == nil {
		// PgBouncer is disabled.
		action = func(ctx context.Context, exec ivory.Executor) error {
			return errors.WithStack(pgbouncer.DisableInIvorySQL(ctx, exec))
		}
	}

	// First, calculate a hash of the SQL that should be executed in IvorySQL.
...
func (r *Reconciler) generatePGBouncerService(
	cluster *v1beta1.IvoryCluster) (*corev1.Service, bool, error,
) {
...
func (r *Reconciler) reconcilePGBouncerPodDisruptionBudget(
	...
	deleteExistingPDB := func(cluster *v1beta1.IvoryCluster) error {
