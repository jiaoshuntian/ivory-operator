...
import (
	...
	"github.com/highgo/ivory-operator/internal/testing/events"
...
func TestGetPVCNameMethods(t *testing.T) {
	...
	namespace := "ivory-operator-test-get-pvc-name"
...
- command:
  - bash
  - -ceu
  - "echo \"Preparing cluster testcluster volumes for IVO v5.x\"\n    echo \"pgdata_pvc=testpgdata\"\n
    ...
    \"IVY Data directory preparation complete\"\n    "
  image: example.com/highgo-ivory-ha:test
...
- command:
  - bash
  - -ceu
  - "echo \"Preparing cluster testcluster pgBackRest repo volume for IVO v5.x\"\n
