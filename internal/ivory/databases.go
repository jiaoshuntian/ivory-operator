...
// CreateDatabasesInIvorySQL calls exec to create databases that do not exist
// in IvorySQL.
...
`)
	...
	// - https://www.ivorysql.org/docs/current/sql-createdatabase.html
	_, _ = sql.WriteString(`
...
`)
	...
	log.V(1).Info("created IvorySQL databases", "stdout", stdout, "stderr", stderr)
