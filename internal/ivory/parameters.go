...
func NewParameters() Parameters {
	...
	// IvorySQL must be restarted when changing this value.
	// - https://www.ivorysql.org/docs/current/runtime-config-wal.html#GUC-WAL-LEVEL
	// - https://www.ivorysql.org/docs/current/runtime-config-replication.html
	// - https://www.ivorysql.org/docs/current/logical-replication.html
	parameters.Mandatory.Add("wal_level", "logical")

	// Always enable SSL/TLS.
	// IvorySQL must be reloaded when changing this value.
	...
	// - https://www.ivorysql.org/docs/current/jit.html
	parameters.Default.Add("jit", "off")

	// SCRAM-SHA-256 is preferred over MD5, but allow users to disable it when
	// necessary. IvorySQL 10 is the first to support SCRAM-SHA-256, and
	// IvorySQL 14 makes it the default.
...
// - https://www.ivorysql.org/docs/current/config-setting.html
