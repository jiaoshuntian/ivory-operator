...
// IvoryPassword is the interface that defines the methods required to build
// a password for IvorySQL in a desired format (e.g. MD5)
type IvoryPassword interface {
...
// NewIvoryPassword accepts a type of password (e.g. md5) which is used to
