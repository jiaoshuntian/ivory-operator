...
// scramVerifierFormat is the format of the value that is stored by IvorySQL
// and follows the format:
//
// <DIGEST>$<ITERATIONS>:<SALT>$<STORED_KEY>:<SERVER_KEY>
//
// where:
// DIGEST = SCRAM-SHA-256 (only value for now in IvorySQL)
...
// These constants are defined as part of the IvorySQL implementation for
...
// SCRAMPassword contains the building blocks to build a IvorySQL SCRAM
// verifier. Implements the IvoryPassword interface
...
// saslPrep returns the canonical form of a password for IvorySQL when
...
// See:
//
// https://git.ivorysql.org/gitweb/?p=ivorysql.git;a=blob;f=src/common/saslprep.c
