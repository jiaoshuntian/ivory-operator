...
pg1-host-ca-file = /etc/pgbackrest/conf.d/~ivory-operator/tls-ca.crt
pg1-host-cert-file = /etc/pgbackrest/conf.d/~ivory-operator/client-tls.crt
pg1-host-key-file = /etc/pgbackrest/conf.d/~ivory-operator/client-tls.key
pg1-host-type = tls
...
repo1-host-ca-file = /etc/pgbackrest/conf.d/~ivory-operator/tls-ca.crt
repo1-host-cert-file = /etc/pgbackrest/conf.d/~ivory-operator/client-tls.crt
repo1-host-key-file = /etc/pgbackrest/conf.d/~ivory-operator/client-tls.key
repo1-host-type = tls
repo1-host-user = ivory
repo1-path = /pgbackrest/repo1
repo2-azure-container = a-container
repo2-path = /pgbackrest/repo2
repo2-type = azure
...
tls-server-ca-file = /etc/pgbackrest/conf.d/~ivory-operator/tls-ca.crt
