...
func (in *DataSource) DeepCopyInto(out *DataSource) {
	*out = *in
	...
	if in.IvoryCluster != nil {
		in, out := &in.IvoryCluster, &out.IvoryCluster
		*out = new(IvoryClusterDataSource)
		(*in).DeepCopyInto(*out)
	}
	if in.Volumes != nil {
...
func (in *IvoryAdditionalConfig) DeepCopy() *IvoryAdditionalConfig {
	if in == nil {
		return nil
	}
	out := new(IvoryAdditionalConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IvoryClusterDataSource) DeepCopy() *IvoryClusterDataSource {
	if in == nil {
		return nil
	}
	out := new(IvoryClusterDataSource)
...
func (in *IvoryClusterSpec) DeepCopyInto(out *IvoryClusterSpec) {
	*out = *in
	...
	if in.InstanceSets != nil {
		...
		*out = make([]IvoryInstanceSetSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *IvoryClusterStatus) DeepCopyInto(out *IvoryClusterStatus) {
	*out = *in
	if in.InstanceSets != nil {
		in, out := &in.InstanceSets, &out.InstanceSets
		*out = make([]IvoryInstanceSetStatus, len(*in))
		copy(*out, *in)
	}
	...
	if in.UserInterface != nil {
		in, out := &in.UserInterface, &out.UserInterface
		*out = new(IvoryUserInterfaceStatus)
		**out = **in
	}
...
func (in *IvoryInstanceSetSpec) DeepCopy() *IvoryInstanceSetSpec {
	if in == nil {
		return nil
	}
	out := new(IvoryInstanceSetSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IvoryInstanceSetStatus) DeepCopy() *IvoryInstanceSetStatus {
	if in == nil {
		return nil
	}
	out := new(IvoryInstanceSetStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IvoryUserInterfaceStatus) DeepCopy() *IvoryUserInterfaceStatus {
	if in == nil {
		return nil
	}
	out := new(IvoryUserInterfaceStatus)
...
func (in *IvoryUserSpec) DeepCopyInto(out *IvoryUserSpec) {
	*out = *in
	if in.Databases != nil {
		...
		*out = make([]IvoryIdentifier, len(*in))
		copy(*out, *in)
	}
	if in.Password != nil {
...
func (in *PGBackRestRestore) DeepCopyInto(out *PGBackRestRestore) {
	*out = *in
	...
	if in.IvoryClusterDataSource != nil {
		in, out := &in.IvoryClusterDataSource, &out.IvoryClusterDataSource
		*out = new(IvoryClusterDataSource)
		(*in).DeepCopyInto(*out)
	}
}
