...
type PatroniStatus struct {
	...
	// - "system_identifier" of https://www.ivorysql.org/docs/current/functions-info.html#FUNCTIONS-IVY-CONTROL-SYSTEM
	// - "systemid" of https://www.ivorysql.org/docs/current/protocol-replication.html
